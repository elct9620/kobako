...
| `Kobako::ServiceError` | E-11..E-13, E-15, E-21..E-23, E-43, E-44, E-48 — E-12 / E-13 / E-43 / E-48 raised as the `Kobako::NoServiceError` subclass, E-15 as the `Kobako::ServiceArgumentError` subclass |
...
- **Yield round-trip:** the reverse-direction Call/Reply pair. The Host Gem re-enters the guest synchronously when a Service method invokes its Yielder (B-24); yield round-trips nest strictly within the dispatch frame that produced the Yielder and stack in LIFO order; each frame holds at most one Yielder.
