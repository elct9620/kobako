...
- The `kobako` gem name, the public Ruby class names `Kobako::Sandbox`, `Kobako::RPC::Handle`, `Kobako::RPC::Namespace`, `Kobako::TrapError`, `Kobako::SandboxError`, `Kobako::ServiceError`, and the documented public method surface on `Kobako::Sandbox` (`#define`, `#preload`, `#eval`, `#run`, plus the output reader and truncation predicates) are stable public contracts
