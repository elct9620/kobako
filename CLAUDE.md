...
| SPEC regression benchmarks (gated, #1..#6) | `bundle exec rake bench`; `rake -T bench` lists the characterization and gate tasks, whose workflow lives in `benchmark/README.md` |
