...
| Guest IO / `$stdout` / `$stderr` | `wasm/kobako-io/src/{io,kernel}.rs` | Pure-Rust `beni::Gem` (no mrblib / mrbc pipeline); Kernel delegators registered private via the `beni::sys` escape hatch. SPEC B-04. |
