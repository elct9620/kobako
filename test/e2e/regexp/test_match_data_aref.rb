...
# MatchData#[] argument forms beyond a single group index: a start+length or
# a Range slices the group list (whole match then captures); a negative index
# counts from the end; an undefined capture name raises.
