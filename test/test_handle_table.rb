...
module Kobako
  class HandleTableTest < Minitest::Test
    ...
    # ---------- Cap exhaustion: alloc beyond RPC::Handle::MAX_ID raises ----------
    ...
    def test_alloc_at_max_id_succeeds_then_next_alloc_raises
      ...
      table = Table.new(next_id: RPC::Handle::MAX_ID)

      id = table.alloc(Object.new)
      assert_equal RPC::Handle::MAX_ID, id
    ...
    def test_max_id_constant_is_wire_invariant
      ...
      assert_equal 0x7fff_ffff, RPC::Handle::MAX_ID
      assert_equal (2**31) - 1, RPC::Handle::MAX_ID
    end
