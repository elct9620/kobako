...
# Differential parity — invocation isolation: both frontends must start
# every invocation from the canonical boot state, leaving no trace of the
# previous one.
class TestParityIsolation < Parity::Case
  # @behavior S-016
  # Globals, constants, and reopened core classes from one invocation are
