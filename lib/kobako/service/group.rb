...
module Kobako
  module Service
    ...
    # the two-level path `GroupName::MemberName` that guest code addresses.
    #
    # `bind` accepts any Ruby object — class, instance, or module — uniformly;
    ...
    class Group
      ...
      # @param object [Object] any object responding to the methods guest
      #   code will invoke.
