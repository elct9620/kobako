...
module Kobako
  module Wire
    ...
    class Encoder
      ...
      # append it to the backing buffer. Used by the envelope layer for the
      # Panic envelope, where field order is observable on the wire.
