...
| E-10 | Guest presents an invalid wire payload as a dispatch argument — a Capability Handle frame the payload codec refuses per [`docs/wire/payload-msgpack.md`](../wire/payload-msgpack.md) § Ext Types → ext 0x01 | B-16 — Handle as dispatch argument |
