...
B-42 B-43 B-45 B-49 B-50 B-55 B-56 B-62 B-63
...
- **Retired** — E-14 and E-50 (N-8: reserved and never reassigned) name no
  behavior, so neither appears in a scenario nor needs one.
