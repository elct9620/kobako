...
/// [`Kobako`] token needs to keep around.
///
/// # Safety
///
...
#[cfg(target_arch = "wasm32")]
unsafe fn install_kobako_classes(mrb: *mut sys::mrb_state) -> KobakoClasses {
...
#[cfg(target_arch = "wasm32")]
unsafe fn install_io_globals(mrb: *mut sys::mrb_state) {
    // SAFETY: see item-level doc.
    unsafe {
...
#[cfg(target_arch = "wasm32")]
unsafe fn install_kernel_delegators(mrb: *mut sys::mrb_state) {
    // SAFETY: see item-level doc.
    unsafe {
...
impl Kobako {
    ...
    pub unsafe fn install_raw(mrb: *mut sys::mrb_state) -> Self {
        #[cfg(target_arch = "wasm32")]
        {
            ...
            let classes = unsafe { install_kobako_classes(mrb) };
            unsafe { install_io_globals(mrb) };
            unsafe { install_kernel_delegators(mrb) };
